...
HD_PWD='C:/Projects/Casioproject/Casio/Casio/Casio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Casio_Design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Casio_Design_wrapper.tcl -notrace
